      ...
      <ul className="social-icon">
        <li className="social-icon-item">
          <a
            ...
            target="_blank"
            href="https://www.facebook.com/nothaiderali"
          >
        ...
        <li className="social-icon-item">
          <a
            className="social-icon-link"
            target="_blank"
            href="https://www.instagram.com/nothaiderali"
          >
            <svg width="32" height="32" fill="currentColor" viewBox="0 0 16 16">
        ...
        <li className="social-icon-item">
          <a
            className="social-icon-link"
            target="_blank"
            href="https://www.threads.net/nothaiderali"
          >
            <svg width="32" height="32" fill="currentColor" viewBox="0 0 16 16">
        ...
        <li className="social-icon-item">
          <a
            className="social-icon-link"
            target="_blank"
            href="https://www.twitter.com/nothaiderali"
          >
            <svg width="32" height="32" fill="currentColor" viewBox="0 0 16 16">
